<?php
        ...
        $conn = new mysqli($servername, $username, $password, $dbname);
         ...
         if ($result->num_rows > 0) {
          ...
          echo "<tr><td>".$pid."</td><td>".$pname."</td><td>".$album_artists."</td><td>".$genre."</td><td>".$info."</td><td>".$year."</td><td>".$duration."</td><td>".$price."</td><td>".$doe."</td><td>".$imageString."</td>".$editButttonString."</tr>";
         	}
         }
         else {
         	echo "0";
