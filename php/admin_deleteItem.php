<?php
        ...
        $conn = new mysqli($servername, $username, $password, $dbname);
         ...
         $sql = "SELECT * FROM inventory where `flag`= 0";
         ...
         if ($result->num_rows > 0) {
          ...
          $deleteButttonString="<td><button  class='btn btn-default' id='delete' onclick='deleteSong(".$pid.")'>Delete</button></td>";
          echo "<tr><td>".$pid."</td><td>".$pname."</td><td>".$album_artists."</td><td>".$genre."</td><td>".$info."</td><td>".$year."</td><td>".$duration."</td><td>".$price."</td><td>".$doe."</td><td>".$imageString."</td>".$deleteButttonString."</tr>";
         	}
         }
         else {
         	echo "0";
