...
function validationfunc(key,name){
  ...
  console.log(title,artists,genre,description,dur,year,price,file,id);
  var error = "";
  if(title.length < 1){
  ...
  if(error != ""){
    ...
    $.ajax({
      ...
      data: {title:title,artists:artists,genre:genre,description:description,dur:dur,year:year,price:price,id:id},
